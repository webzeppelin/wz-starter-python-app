...
@Component({
    selector: 'search-guestbook',
    templateUrl: 'search-guestbook.component.html',
    styleUrls: ['./search-guestbook.component.scss']
})
export class SearchGuestbookComponent implements OnInit {
